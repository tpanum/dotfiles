...
(setq
 ...
 `(("znc-freenode"
   ...
   ("znc-bitlbee"
    ...
    :channels (:after-auth "#slack-aau-general" "#slack-aau-ntp" "#slack-aau-backend" "#slack-aau-random" "#slack-aau-research")
    :lagmon-disabled t
    :tls t
    )))
...
(defun circe-notifications-notify (nick body channel)
  (if (not (string-match "^\[[0-9]+:[0-9]+\]" body)) ; make sure playback messages from znc are not displayed
      (alert
       body
