...
(use-package org
	     ...
	     (setq org-todo-keywords
		   '((sequence "TODO(t)" "|" "DONE(d)" "|" "IDEA(i)")))
	     (setq org-latex-logfiles-extensions (quote ("lof" "lot" "tex~" "aux" "idx" "log" "out" "toc" "nav" "snm" "vrb" "dvi" "fdb_latexmk" "blg" "brf" "fls" "entoc" "ps" "spl" "bbl")))
	     (setq org-latex-pdf-process (list "latexmk -shell-escape -bibtex -f -pdf %f"))
	     (setq org-capture-templates
		   '(("p" "Personal (Todo)" entry (file+headline "~/org/todo.org" "Personal")
		      "* TODO %? :personal: \n %i\n %a")
		     ("r" "Research (Todo)" entry (file+headline "~/org/todo.org" "Research")
		      "* TODO %? :research: \n %i\n %a")
                     ("i" "Idea" entry (file+headline "~/org/todo.org" "Tasks")
		      "* IDEA %? :idea:\nCaptured %U\n %i\n %a")))
...
(general-define-key :keymaps 'weechat-mode-map
:states '(normal)
"/" 'evil-search-forward)
(face-remap-add-relative 'weechat-nick-self-face 'my-irc-nick-face)
(set-face-attribute 'weechat-nick-self-face nil :foreground "#5E81AC")
(set-face-attribute 'weechat-highlight-face nil :foreground "#EBCB8B" :weight 'bold)
(set-face-attribute 'weechat-time-face nil :foreground "#4C566A")


(setq weechat-color-list '(unspecified "#FFFFFF" "#A5A5A5" "#EBCB8B" "#CC4552"
                                       "#008C58" "#A3BE8C" "#BF616A"
                                       "#D08770" "#81A1C1" "#88C0D0"
                                       "#8A5196" "#B48EAD" "#8FBCBB"
                                       "#778FAA" "#DB8EAD" "#B1D185"))
...
(defun tpanum/irc-connect ()
  (interactive)
        (weechat-connect
"weechat.panum.dk"
5000
(password-store-get "personal/weechat-relay")
'ssl))
#+END_SRC
*** Password Store
#+BEGIN_SRC emacs-lisp
