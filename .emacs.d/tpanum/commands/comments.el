;;;###autoload
(defun tpanum/insert-header-comment ()
  ...
  (let ((header))
    ...
    (let* ((ender (tpanum/string-trim (or comment-end "")))
           (starter (tpanum/string-trim (or comment-start "#")))
           ...
           (indent-size (length
                         (tpanum/regex-replace
                          ...
                          (concat "\\(" (regexp-quote
                                  ...
                                  "\\)+$") "")))
           (outdent-size (length (tpanum/regex-replace
                                  ender
                                  (concat "^\\("
                                          (regexp-quote
                                           (char-to-string starter-tail))
